          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
            <Card className="p-6">
              <CardHeader
                ...
                description="Speak symptoms or clinical notes — transcribed in real-time with language detection."
              />
              <div className="space-y-4">
                <VoiceTranscription language="en-IN" onTranscript={(t) => console.log("EN transcript:", t)} />
                <div className="h-px bg-white/60" />
                <div className="text-xs font-medium text-muted mb-2">Hindi Mode (हिंदी)</div>
                <VoiceTranscription language="hi-IN" onTranscript={(t) => console.log("HI transcript:", t)} />
              </div>
            </Card>
          </motion.div>
        </div>
